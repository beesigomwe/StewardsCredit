...
INSERT INTO `accounts` (`accounts_id`, `accounts_name`, `opening_balance`, `note`) VALUES
(1, 'Food', 500000, 'Money for food'),
(2, 'Transportation', 2000000, 'Transport account'),
(3, 'Salary', 0, 'Monthly salary');
...
INSERT INTO `transaction` (`trans_id`, `accounts_name`, `trans_date`, `type`, `category`, `amount`, `payer`, `payee`, `p_method`, `ref`, `note`, `dr`, `cr`, `bal`) VALUES
(1, 'Food', '2019-03-05', 'Transfer', '', 500000, 'System', '', '', '', 'Opening Balance', 0, 500000, 500000),
(2, 'Transportation', '2019-03-05', 'Transfer', '', 2000000, 'System', '', '', '', 'Opening Balance', 0, 2000000, 2000000),
(3, 'Salary', '2019-03-05', 'Income', 'Salary', 5000000, 'Standard Chartered Bank', '', 'Check', '0001', 'Monthly salary', 0, 5000000, 5500000),
(4, 'Salary', '2019-03-05', 'Transfer', '', 0, 'System', '', '', '', 'Opening Balance', 0, 0, 0),
(5, 'Food', '2019-03-05', 'Expense', 'Maintainance', 4000000, '', 'Employee', 'Cash', '0001', 'Money for food', 4000000, 0, -3500000);
...
(2, 'admin', '', 'kahwashabban@gmail.com', 'Admin', 'e10adc3949ba59abbe56e057f20f883e', '2019-03-05 14:54:05', '2019-03-05 16:25:14'),
(3, 'Ruth', 'Musoke', 'ruthmusoke@gmail.com', 'Employee', 'e10adc3949ba59abbe56e057f20f883e', '2019-03-05 15:28:55', '2019-03-05 15:42:01');
