...
<link href="<?php echo base_url() ?>/theme/css/my-style.css?<?= date('Ymd') ?>" rel="stylesheet">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 headerbar">
          <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 left-headerbar">
            <ul class="leftheader-menu">
              <li><a href="<?= base_url().'..' ?>">Stewards</a></li>
    ...
    <aside>
      <div class="sidebar">
        ...
        <ul id="menu" class="menu-helper asyn-menu">
          ...
          <li style="background: linear-gradient(0deg, #536976, #292E49, #536976)!important;border-top: 1px solid #89959e;border-bottom: 1px solid #f1f1f1;height: 41px;"><a class="" href="#" target="_parent" onclick="window.location.replace('<?= site_url('../admin') ?>')"><i  class="fa fa-home" style="color: white; "></i> <span class="title" style="display: inline;color: white;font-weight: bold;">Front Office</span></a></li>
