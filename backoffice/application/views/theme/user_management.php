                     ...
                     <table id="user-table" class="table table-striped table-bordered table-condensed">
                        ...
                        <?php foreach($users as $user){ ?>
                            <tr>
                                ...
                                <td><a class="mybtn btn-info btn-xs edit-user-btn" href="<?php echo site_url('Admin/getUser/'.$user->id) ?>">Edit</a>
                                    <!--<a class="mybtn btn-danger btn-xs remove-btn" href="<?php echo site_url('Admin/userManagement/remove/'.$user->id) ?>">Remove</a>-->
                                </td>     
                            </tr>
                        <?php } ?>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click','.edit-user-btn',function(){
            ...
            $.ajax({url:url,beforeSend : function(){
                ...
                $("#user-type").select2("val",json['role']);  
                $("#action").val("update");
                $("#id").val(json['id']);
