        ...
        <div class="col-md-5 col-lg-5 col-sm-5">
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body add-client">
             <form id="add-income" method="post" action="<?php echo site_url('Admin/addIncome/insert') ?>">
               ...
               <div class="form-group"> 
                ...
                <select name="account" class="form-control" id="account">  
                  <?php foreach ($accounts as $account) {?>
                    <option value="<?php echo $account->accounts_id ?>"><?php echo $account->accounts_name ?></option>
                  <?php } ?>
                </select>      
              </div> 
              <div class="form-group">
            ...
            <div class="form-group"> 
              ...
              <select name="income-type" class="form-control" id="income-type"> 
               <?php foreach ($category as $cat) {?>
                <option value="<?php echo $cat->chart_id ?>"><?php echo $cat->accounts_name ?></option>
              <?php } ?> 
            </select>      
          </div>      
          ...
          <div class="form-group"> 
            ...
            <select name="p-method" class="form-control" id="p-method"> 
              <?php foreach ($p_method as $method) {?>
                <option value="<?php echo $method->p_method_id ?>"><?php echo $method->p_method_name ?></option>
              <?php } ?> 
            </select>      
          </div>    
          ...
          <div class="form-group"> 
            ...
            <select name="payer" class="form-control" id="payer">  
              <?php foreach ($payers as $p) {?>
                <option value="<?php echo $p->trace_id ?>"><?php echo $p->payee_payers ?></option>
              <?php } ?>   
            </select>      
          </div>  
