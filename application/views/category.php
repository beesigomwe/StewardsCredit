	...
	<div class="container">
		<div class="row">
			...
			<div class="page-breadcrumb">
				<ol class="breadcrumb">
					...
					if (!empty($category_array['subcategory']) && !empty($category_array['parent_category'])):?>
						<li class="breadcrumb-item">
							<a href="<?= generate_category_url(null, $category_array['parent_category']->slug); ?>"><?= html_escape($category_array['parent_category']->name); ?></a>
						</li>
			...
			<div class="col-xs-12 col-sm-12 col-md-8">
				<div class="content">
					<h1 class="page-title"> <?= html_escape(trans("category")); ?>
						: <?= html_escape($category->name); ?></h1>

					<!-- posts -->
					<div class="col-xs-12 col-sm-12 posts <?= ($layout == "layout_3" || $layout == "layout_6") ? 'p-0 posts-boxed' : ''; ?>">
						<div class="row">
							<?php $count = 0; ?>
