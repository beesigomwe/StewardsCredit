...
<div class="widget-title">
	<h4 class="title"><?= html_escape(trans("random_posts")); ?></h4>
</div>
						...
						foreach ($this->random_posts as $item) :
							if ($count < 5): ?>
								...
								<div class="home-slider-boxed-item">
									...
									<div class="item-info redirect-onclik" data-url="<?= generate_post_url($item); ?>">
										...
										<h3 class="title">
											<a href="<?= generate_post_url($item); ?>">
												<?= html_escape(character_limiter($item->title, 70, '...')); ?>
											</a>
										</h3>
									</div>
								</div>
