            ...
            <?php if ($page->breadcrumb_active == 1): ?>
                <div class="page-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><?= html_escape($page->title); ?></li>
                    </ol>
                </div>
            <?php else: ?>
                        ...
                        <div class="page-contact">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-xs-12 contact-left">
                                    ...
                                    <!-- form start -->
                                    <?= form_open('home_controller/contact_post', ['id' => 'form_validate', 'class' => 'validate_terms']); ?>
                                    <div class="form-group">
                                        <input type="text" class="form-control form-input" name="name"
                                               placeholder="<?= trans("name"); ?>" maxlength="199" minlength="1"
                                               pattern=".*\S+.*" value="<?= old('name'); ?>" required <?= ($rtl == true) ? 'dir="rtl"' : ''; ?>>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <textarea class="form-control form-input form-textarea" name="message"
                                              placeholder="<?= trans("message"); ?>" maxlength="4970"
                                              minlength="5"
                                              required <?= ($rtl == true) ? 'dir="rtl"' : ''; ?>><?= old('message'); ?></textarea>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6 col-xs-12 contact-right">
                                    ...
                                    <?php if ($settings->contact_phone): ?>
                                        <div class="contact-item">
                                            ...
                                            <div class="col-sm-10 col-xs-10 contact-info">
                                                <?= html_escape($settings->contact_phone); ?>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <?php if ($settings->contact_email): ?>
                                        <div class="contact-item">
                                            ...
                                            <div class="col-sm-10 col-xs-10 contact-info">
                                                <?= html_escape($settings->contact_email); ?>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <?php if ($settings->contact_address): ?>
                                        <div class="contact-item">
                                            ...
                                            <div class="col-sm-10 col-xs-10 contact-info">
                                                <?= html_escape($settings->contact_address); ?>
                                            </div>
                                        </div>
                                    <?php endif; ?>
