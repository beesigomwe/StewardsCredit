			...
			<div class="row">
				<div class="col-6">
					<div class="form-group">
						<div class="form-label">Withdraw Category</div>
						<div class="custom-switches-stacked">
							<label class="custom-switch">
								<input type="radio" name="category" value="1" class="custom-switch-input" checked="" onchange="draw_amount();">
								<span class="custom-switch-indicator"></span>
								<span class="custom-switch-description">Interest Payout</span>
							</label>
							<label class="custom-switch">
								<input type="radio" name="category" value="2" class="custom-switch-input" onchange="draw_amount();">
								<span class="custom-switch-indicator"></span>
								<span class="custom-switch-description">Redemption</span>
							</label>
							<label class="custom-switch">
								<input type="radio" name="category" value="3" class="custom-switch-input" onchange="draw_amount();">
								<span class="custom-switch-indicator"></span>
								<span class="custom-switch-description">Both Interest & Principal</span>
							</label>
						</div>
					</div>
				</div>
				<div class="col-6">
					...
					<h3 class="draw_amount">UGX 1,000,000</h3>
				</div>
			</div>
			<div class="row">
				<div class="col-6">
...
<script type="text/javascript">
	...
	function draw_amount(){
		var data = $("#make_withdraw_transaction").serializeArray();
		var category = data[5].value;
		switch(category){
			case "1":
			$('.draw_amount').html(currency+' '+interest);
			break;
			case "2":
			$('.draw_amount').html(currency+' '+principal);
			break;
			case "3":
			$('.draw_amount').html(currency+' '+accountbalance);
			break;
		}
