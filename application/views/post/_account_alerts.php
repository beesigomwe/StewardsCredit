...
<fieldset class="form-fieldset">
	<div class="form-group">
		<label class="form-label">Alert name<span class="form-required">*</span></label>
		<input type="text" disabled class="form-control">
	</div>
	<div class="row">
		<div class="col-6">
			<div class="form-group">
				<label class="form-label">Alert Start Date</label>
				<div class="row gutters-xs">
					<div class="col-4">
						<select disabled name="user[month]" class="form-control custom-select">
					...
					<div class="col-4">
						<select disabled name="user[day]" class="form-control custom-select">
					...
					<div class="col-4">
						<select disabled name="user[year]" class="form-control custom-select">
		...
		<div class="col-6">
			...
			<div class="row gutters-xs">
				<div class="col-12">
					<select disabled name="user[Frequency]" class="form-control custom-select">
...
<div class="form-footer">
	<button disabled class="btn btn-primary btn-block">Submit</button>
</div>
</div>
</div>
<div class="card">
