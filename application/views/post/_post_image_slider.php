	...
	if (!empty($post_item->image_url) || $post_item->image_mime == 'gif' || $post_item->post_type == 'video'):?>
		<div class="external-image-container">
			<?php if ($post_item->post_type == 'video'): ?>
				<img src="<?= base_url(); ?>assets/img/icon_play.svg" alt="icon" class="post-icon <?= $video_icon_class; ?>"/>
			<?php endif; ?>
			<img src="<?= $post_image_bg; ?>" class="img-responsive" alt="fixer">
			<img src="<?= $post_image_bg; ?>" data-lazy="<?= $post_image_url; ?>" class="img-responsive img-slider img-external" alt="<?= html_escape($post_item->title); ?>">
		</div>
	<?php else: ?>
		<img src="<?= $post_image_bg; ?>" class="img-responsive" alt="fixer">
		<img src="<?= $post_image_bg; ?>" data-lazy="<?= $post_image_url; ?>" class="img-responsive img-slider img-external" alt="<?= html_escape($post_item->title); ?>">
