...
<?php if ($layout == "layout_2" || $layout == "layout_5"): ?>
	...
	<div class="post-item-horizontal">
		<div class="item-image">
			<a href="<?= generate_category_url($item->parent_category_slug, $item->category_slug); ?>">
		...
		<div class="item-content">
			...
			<h3 class="title">
				<a href="<?= generate_post_url($item); ?>">
					<?= html_escape(character_limiter($item->title, 55, '...')); ?>
				</a>
			</h3>
			<?php $this->load->view("post/_post_meta", ['item' => $item]); ?>
			<p class="summary">
				<?= html_escape(character_limiter($item->summary, 130, '...')); ?>
			</p>
			<div class="post-buttons">
				<a href="<?= generate_post_url($item); ?>" class="pull-right read-more">
					<?= html_escape(trans("readmore")); ?>
	...
	<div class="col-sm-6 col-xs-12 item-boxed-cnt">
		...
		<div class="col-xs-12 post-item-boxed p0">
			...
			<div class="item-content">
				<h3 class="title">
					<a href="<?= generate_post_url($item); ?>">
						<?= html_escape(character_limiter($item->title, 50, '...')); ?>
					</a>
				</h3>
				<?php $this->load->view("post/_post_meta", ['item' => $item]); ?>
				<p class="summary">
