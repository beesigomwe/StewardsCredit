...
<div class="row">
    <div class="col-lg-5 col-md-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title"><?= trans('add_subcategory'); ?></h3>
            </div>
            <!-- /.box-header -->

            <!-- form start -->
            <?= form_open('category_controller/add_subcategory_post'); ?>
    ...
    <div class="col-lg-7 col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="pull-left">
                    <h3 class="card-title"><?= trans('subcategories'); ?></h3>
                </div>
            </div><!-- /.box-header -->
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu options-dropdown">
                                                    <li>
                                                        <a href="<?= admin_url(); ?>update-subcategory/<?= html_escape($item->id); ?>"><i class="fa fa-edit option-icon"></i><?= trans('edit'); ?></a>
                                                    </li>
                                                    <li>
