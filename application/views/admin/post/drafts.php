	...
	<div class="card-header">
		...
		<div class="card-options">
			<a href="<?= admin_url(); ?>create-account">
				...
				type="button"><i class="fa fa-plus"></i> <?= trans('add_post'); ?></button>                    
			</a>
		</div>
	</div>
	<div class="">
		<table class="table table-hover table-outline table-vcenter text-nowrap card-table" style="background: whitesmoke; border-bottom: 1px solid gainsboro; "> 
			<tbody>
				<tr>
					<td>
