									...
									<div id="image_file_upload_response">
										<?php foreach ($images as $image): ?>
											<div class="col-file-manager" id="img_col_id_<?= $image->id; ?>">
												<div class="file-box" data-file-id="<?= $image->id; ?>" data-file-path="<?= $image->image_mid; ?>">
													<div class="image-container">
														<img src="<?= base_url() . $image->image_slider; ?>" alt="" class="img-responsive">
													</div>
													<?php if (!empty($image->file_name)): ?>
														<span class="file-name"><?= limit_character($image->file_name . "." . $image->image_mime, 25, '..'); ?></span>
													<?php endif; ?>
												</div>
											</div>
										<?php endforeach; ?>
...
<script>
    var txt_processing = "<?= trans("txt_processing"); ?>";
    $(function () {
