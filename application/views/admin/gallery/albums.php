...
<div class="row">
    <div class="col-lg-4 col-md-12">
        <div class="card">
            ...
            <!-- form start -->
            <?= form_open('gallery_controller/add_gallery_album_post'); ?>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu options-dropdown">
                                                    <li>
                                                        <a href="<?= admin_url(); ?>update-gallery-album/<?= html_escape($item->id); ?>"><i class="fa fa-edit option-icon"></i><?= trans('edit'); ?></a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)" onclick="delete_item('gallery_controller/delete_gallery_album_post','<?= $item->id; ?>','<?= trans("confirm_album"); ?>');"><i class="fa fa-trash option-icon"></i><?= trans('delete'); ?></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
