...
<div class="card">
    <div class="card-header">
        ...
        <div class="right">
            <a href="<?= admin_url(); ?>add-poll" class="btn btn-success btn-add-new">
                    ...
                    <table class="table table-bordered table-striped dataTable" id="cs_datatable_lang" role="grid"
                        ...
                        <?php foreach ($polls as $item): ?>
                            <tr>
                                ...
                                <td class="break-word"><?= html_escape($item->question); ?>&nbsp;&nbsp;&nbsp;
                                    <button class="btn btn-info btn-xs" data-toggle="modal"
                                            data-target="#pollModal<?= html_escape($item->id); ?>"><?= trans('view_results'); ?>
                                    </button>
                                </td>
                                <td>
                                    <?php
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu options-dropdown">
                                            <li>
                                                <a href="<?= admin_url(); ?>update-poll/<?= html_escape($item->id); ?>"><i class="fa fa-edit option-icon"></i><?= trans('edit'); ?></a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0)" onclick="delete_item('poll_controller/delete_poll_post','<?= $item->id; ?>','<?= trans("confirm_poll"); ?>');"><i class="fa fa-trash option-icon"></i><?= trans('delete'); ?></a>
                                            </li>
                                        </ul>
                                    </div>
                                </td>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><?= html_escape($poll->question); ?></h4>
                </div>
                ...
                <div class="modal-body">
                    <div class="poll">
                        ...
                        <div class="result">
                            ...
                            <p class="total-vote text-center"><strong><?= trans('total_vote'); ?><?= $total_vote; ?></strong></p>
