...
class Auth_model extends CI_Model{
	...
	public function input_values(){
		...
		$data = array(
			'firstname' => remove_forbidden_characters($this->input->post('firstname', true)),
			'lastname' => remove_forbidden_characters($this->input->post('lastname', true)),
			'username' => remove_forbidden_characters($this->input->post('username', true)),
			'mobile' => remove_forbidden_characters($this->input->post('mobile', true)),
