...
class Post_admin_model extends CI_Model {
	...
	public function get_payment_methods(){
		...
		$this->db->order_by("p_method_id", "asc");    
	...
	public function input_values(){
		...
		$data = array(
			...
			'title_slug' => (date('Ymd').str_pad($this->input->post('userid', true), 4, '0', STR_PAD_LEFT).date('Hi') - 2019851212240000),
			...
			'interestperiod' => $this->input->post('interestperiod', true),
