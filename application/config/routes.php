...
$route['member/(:any)'] = 'profile_controller/member/$1';
$route['tag/(:any)'] = 'home_controller/tag/$1';
$route['reading-list'] = 'home_controller/reading_list';
$route['search'] = 'home_controller/search';

$route['receipt/(:any)'] = 'home_controller/receipt/$1';
$route['transaction/(:any)'] = 'home_controller/receipt/$1';
...
$route['user/(:any)'] = 'profile_controller/update_profile/$1';
...
$route[$r_admin . "/create-account"] = 'post_controller/add_post';
$route[$r_admin . "/add-video"] = 'post_controller/add_video';
$route[$r_admin . "/posts"] = 'post_controller/posts';
$route[$r_admin . "/accounts"] = 'post_controller/posts';
...
$route[$r_admin . '/transactions'] = 'admin_controller/comments';
// $route[$r_admin . '/pending-comments'] = 'admin_controller/pending_comments';
$route[$r_admin . '/pending-transactions'] = 'admin_controller/pending_comments';
...
$route[$r_admin . "/new-contact"] = 'admin_controller/add_user';
