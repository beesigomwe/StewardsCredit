...
class Home_controller extends Home_Core_Controller{
	...
	public function search(){
		...
		$data['users'] = $this->post_model->get_paginated_search_users($q, $pagination['per_page'], $pagination['offset']);
	...
	private function post($slug){
		...
		$data['pending'] = $this->comment_model->get_pending($data["post"]->id, $this->comment_limit);
		$data['deleted'] = $this->comment_model->get_deleted($data["post"]->id, $this->comment_limit);
	...
	public function receipt($id){
		...
		$data['title'] = 'Stewards Credit Services';
		$data['description'] = 'Receipt';
		$data['keywords'] = 'Receipt';

		
		$data['details'] = $this->comment_model->get_comment($id);

		$data['post'] = $this->post_model->get_post_by_id($data['details']->post_id);
