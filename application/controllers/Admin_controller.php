...
class Admin_controller extends Admin_Core_Controller{
    ...
    public function index(){
        ...
        $data['comments_count'] = $this->comment_model->get_comments_count();
        $data['pending_comments_count'] = $this->comment_model->get_count_pedding_comments();
    ...
    public function get_menu_links_by_lang()
    {
        ...
        if (!empty($lang_id)):
            $menu_items = $this->navigation_model->get_all_menu_links_by_lang($lang_id);
    ...
    public function delete_transaction(){
        $id = $this->input->post('id', true);
        if ($this->comment_model->delete_transaction($id)) {
            $this->session->set_flashdata('success', trans("comment") . " " . trans("msg_suc_deleted"));
        } else {
            $this->session->set_flashdata('error', trans("msg_error"));
        }
